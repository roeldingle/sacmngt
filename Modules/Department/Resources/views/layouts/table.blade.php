	            ...
	            @foreach($departments as $index=>$row)
	             <tr>
			        ...
			        <td class="" style="text-align:center">
			      	<a href="{{ route( 'department.show', ['id' => $row->id] ) }}"><i class="fa fa-window-maximize" aria-hidden="true"></i></a> |
	                  <a href="{{ route( 'department.edit', ['id' => $row->id] ) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
	                </td>
			      </tr>
	            @endforeach
	          @endif
