                                        ...
                                        <h3 class="text-primary">
                                            <div class="dropdown pull-right">
                                              ...
                                              @if(Auth::user()->role->id == 4)
                                                <span class="label label-{{ $label_class }}"> {{ $ticket->status->name }} </span>
                                              @else
                                                  <button id="status-dropdown" class="btn btn-sm dropdown-toggle label-{{ $label_class }}" data-ticket="{{ $ticket->id }}" type="button" data-toggle="dropdown">
