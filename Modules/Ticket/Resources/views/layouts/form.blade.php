...
<div class="panel-body" style="padding-top:0">
	...
	@endif
	    ...
	    <div class="form-group">
	    	<div class="col-sm-1 col-md-1"></div>
	    	<div class="col-sm-9 col-md-9" style="padding-left: 0;">
			  <label for="role">Ticket Category :</label>
			  <select name="category_id" class="form-control">

			  	@foreach(Modules\Ticket\Entities\TicketCategory::active()->get() as $val)
			  		<option value="{{ $val->id }}"  @if(isset($ticket) && $ticket->category_id == $val->id) selected @endif>{{ $val->name }}</option>
			  	@endforeach
			  </select>
	    	</div>
	    </div>
